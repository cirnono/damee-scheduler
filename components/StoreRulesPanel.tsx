...
export function StoreRulesPanel({
  ...
  return (
    <section className="rounded-2xl border border-neutral-200 bg-white p-6">
      <div className="mb-5">
        <h2 className="text-xl font-bold text-neutral-900">门店排班规则</h2>
      ...
      <div className="mb-6 rounded-2xl border border-neutral-200 bg-neutral-50 p-4">
        <h3 className="mb-3 font-semibold text-neutral-800">添加同班规则</h3>
          ...
          {rules.map((rule) => (
            ...
            >
              <div>
                ...
                {rule.note ? (
                  <p className="mt-1 text-xs text-neutral-400">{rule.note}</p>
                ) : null}
              </div>
